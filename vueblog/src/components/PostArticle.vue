<template>
  <el-container v-loading="loading" class="post-article">
    <el-header class="header">
      <el-select v-model="article.cid" placeholder="请选择报告栏目" style="width: 150px;">
        <el-option
    ...
    <el-main class="main">
      ...
      <div style="display: flex;align-items: center;margin-top: 15px;justify-content: flex-end">
        ...
        <template v-if="from==undefined || from=='draft'">
          ...
          <el-button type="primary" @click="saveBlog(1)">提交</el-button>
        </template>
      ...
      saveBlog(state){
        ...
        postRequest("/article/", {
          ...
          if (resp.status == 200 && resp.data.status == 'success') {
            ...
            _this.$message({type: 'success', message: state == 0 ? '保存成功!' : '提交成功!'});
...
//            }
          ...
          _this.loading = false;
          _this.$message({type: 'error', message: state == 0 ? '保存草稿失败!' : '报告提交失败!'});
        })
      },
      imgAdd(pos, $file){
        var _this = this;
